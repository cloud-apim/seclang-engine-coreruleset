# Contributing to seclang-engine-coreruleset

These guidelines apply to all projects living in the the `cloud-apim/seclang-engine-coreruleset` repository.
...
* [src](https://github.com/cloud-apim/seclang-engine-coreruleset/src): contains the seclang-engine-coreruleset sources and tests
...
1. To avoid duplicated effort, it might be good to check the [issue tracker](https://github.com/cloud-apim/seclang-engine-coreruleset/issues) and [existing pull requests](https://github.com/cloud-apim/seclang-engine-coreruleset/pulls) for existing work.
   - If there is no ticket yet, feel free to [create one](https://github.com/cloud-apim/seclang-engine-coreruleset/issues/new) to discuss the problem and the approach you want to take to solve it.
1. [Fork the project](https://github.com/cloud-apim/seclang-engine-coreruleset#fork-destination-box) on GitHub. You'll need to create a feature-branch for your work on your fork, as this way you'll be able to submit a pull request against the mainline seclang-engine-coreruleset.
...
1. Fork seclang-engine-coreruleset
